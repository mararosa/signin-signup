...
import com.estudos.signupsignin.signup.data.SignUpRepositoryImpl
...
class SignUpInteractorImpl(val repository: SignUpRepository = SignUpRepositoryImpl()) : SignUpInteractor {
